...
const routes: Array<{
  ...
  { path: "/conditions/stress", changeFrequency: "weekly", priority: 0.8 },
  { path: "/conditions/sleep", changeFrequency: "weekly", priority: 0.8 },
  { path: "/conditions/anxiety", changeFrequency: "weekly", priority: 0.8 },
  { path: "/conditions/burnout", changeFrequency: "weekly", priority: 0.8 },

  { path: "/learn", changeFrequency: "weekly", priority: 0.85 },
  { path: "/learn/vagus-nerve", changeFrequency: "weekly", priority: 0.8 },
  { path: "/learn/vagus-nerve-stimulation", changeFrequency: "weekly", priority: 0.82 },
  { path: "/learn/non-invasive-vagus-nerve-stimulation", changeFrequency: "weekly", priority: 0.81 },
  { path: "/learn/nervous-system-regulation", changeFrequency: "weekly", priority: 0.8 },
  ...
  { path: "/research", changeFrequency: "weekly", priority: 0.82 },
  { path: "/research/topics", changeFrequency: "weekly", priority: 0.76 },
  { path: "/research/topics/vagus-nerve-stimulation", changeFrequency: "weekly", priority: 0.74 },
  { path: "/research/topics/safety-and-tolerability", changeFrequency: "weekly", priority: 0.74 },
  { path: "/research/topics/heart-rate-variability", changeFrequency: "weekly", priority: 0.74 },
  ...
  { path: "/research/studies/frangos-2015-auricular-vagus-nerve-stimulation-fmri", changeFrequency: "monthly", priority: 0.66 },
  ...
  { path: "/legal/medical-disclaimer", changeFrequency: "yearly", priority: 0.45 },
  { path: "/legal/intended-use", changeFrequency: "yearly", priority: 0.45 },
  { path: "/legal/regulatory", changeFrequency: "yearly", priority: 0.45 },
  { path: "/legal/ce-compliance", changeFrequency: "yearly", priority: 0.42 },
  { path: "/legal/fda-status", changeFrequency: "yearly", priority: 0.42 },
  { path: "/legal/trust-safety", changeFrequency: "yearly", priority: 0.45 },
