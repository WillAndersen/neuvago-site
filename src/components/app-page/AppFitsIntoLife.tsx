        ...
        <div className="grid gap-12 lg:grid-cols-[1fr_1fr] lg:items-start lg:gap-16">
          ...
          <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-1">
            <BaseCard className="overflow-hidden rounded-[2rem]">
              ...
              <div className="p-6">
                <h3 className="text-xl font-semibold text-[#1f1f1c]">
                  A calmer place in the day
                </h3>
                <p className="mt-3 text-sm leading-6 text-[#5f5a52]">
                  The app is designed to feel realistic to return to across
                  mornings, pauses, and evenings.
                </p>
              </div>
            </BaseCard>
            ...
            <BaseCard className="overflow-hidden rounded-[2rem]">
              ...
              <div className="p-6">
                <h3 className="text-xl font-semibold text-[#1f1f1c]">
                  Calm guidance in context
                </h3>
                <p className="mt-3 text-sm leading-6 text-[#5f5a52]">
                  The experience is built to feel grounded, supportive, and easy
                  to come back to.
                </p>
              </div>
            </BaseCard>
