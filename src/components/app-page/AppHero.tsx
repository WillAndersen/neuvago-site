...
function getAppHeroImage(image: { src: string; alt: string }) {
...
export function AppHero({ content }: AppHeroProps) {
  const desktop = getAppHeroImage(content.desktopImage);
  const mobile = getAppHeroImage(content.mobileImage);
