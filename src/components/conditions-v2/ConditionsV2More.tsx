        ...
        <ul className="border-t border-black/10">
          {content.items.map((item) => (
            <li key={item.id} className="border-b border-black/10">
              <Link
                href={item.href}
                className="group grid gap-5 py-8 transition-colors hover:bg-[#f2eee8]/70 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-[#1f1f1c] sm:grid-cols-[minmax(0,1fr)_auto] sm:items-center sm:gap-8 sm:px-2"
              >
                <div>
