        ...
        <div className="mt-10 border-y border-black/10">
          <div className="grid lg:grid-cols-4">
            {content.flow.map((item, index) => (
              <article
                key={item.title}
                className="relative border-b border-black/8 px-1 py-7 last:border-b-0 lg:border-b-0 lg:border-r lg:px-6 lg:py-8 lg:first:pl-0 lg:last:border-r-0 lg:last:pr-0"
              >
                ...
                {index < content.flow.length - 1 ? (
                  <>
                    <span
                      aria-hidden="true"
                      className="absolute -bottom-3 left-1/2 z-10 flex h-6 w-6 -translate-x-1/2 items-center justify-center bg-[#f7f4ef] text-base text-[#6f675e] lg:hidden"
                    >
                      ↓
                    </span>
                    <span
                      aria-hidden="true"
                      className="absolute -right-3 top-1/2 z-10 hidden h-6 w-6 -translate-y-1/2 items-center justify-center bg-[#f7f4ef] text-base text-[#6f675e] lg:flex"
                    >
                      →
                    </span>
                  </>
