    ...
    <section className="relative isolate overflow-hidden border-b border-black/5 bg-[#f7f4ef] text-[#1f1f1c]">
      ...
      <div className="mx-auto grid max-w-[92rem] gap-10 px-5 py-14 sm:px-8 sm:py-16 lg:grid-cols-[0.86fr_1.14fr] lg:items-center lg:gap-14 lg:px-12 lg:py-20 xl:py-24">
        <div className="max-w-[43rem]">
          ...
          <h1 className="max-w-[12.8ch] text-[clamp(3.15rem,12vw,5.55rem)] font-medium leading-[0.9] tracking-[-0.07em] text-[#1f1f1c] sm:text-[clamp(4.1rem,9vw,6.9rem)] sm:leading-[0.86] lg:text-[clamp(5.2rem,6.7vw,7.8rem)] lg:leading-[0.84] lg:tracking-[-0.085em] hyphens-auto break-words hyphens-none [overflow-wrap:normal] [word-break:normal] text-balance max-[639px]:text-[clamp(2.45rem,11.5vw,4.25rem)] max-[639px]:leading-[0.94] max-[639px]:tracking-[-0.055em]">
            {content.title}
          </h1>
