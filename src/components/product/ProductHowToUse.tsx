      ...
      <div className="mx-auto grid max-w-[92rem] gap-12 px-5 py-20 sm:px-8 lg:grid-cols-[0.85fr_1.15fr] lg:items-start lg:px-12 lg:py-28">
        ...
        <div className="space-y-5">
          {content.steps.map((step, index) => (
            <article
              key={step.title}
              className="grid gap-6 overflow-hidden rounded-[2.15rem] border border-black/5 bg-white/64 p-4 shadow-[0_20px_70px_rgba(31,31,28,0.06)] sm:p-5 md:grid-cols-[0.72fr_1fr] md:items-center"
            >
              {step.image ? (
